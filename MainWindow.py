            ...
            for name in files:
                ...
                if name.endswith('.mp3'):
                    ...
                    if self.music_path in self.list_of_files:
                        ...
                        self.btn = MDRectangleFlatButton(text=file_name[-1], size_hint=(self.width, self.width),
                                                         height=40,
                                                         md_bg_color=self.primary, text_color=self.background,
                                                         line_color=self.background,
                                                         on_press=(lambda x, y=num: self.screen_press(y)))
